...
sudo xbps-install nodejs pnpm xorg base-devel elogind picom git bat papirus-icon-theme lf ueberzug ffmpeg ghostscript zip unzip gzip lxappearance libX11-devel libXinerama-devel libXft-devel xsetroot curl openssh wget bspwm htop pulseaudio pavucontrol alsa-plugins-pulseaudio openjdk-jre cmus rofi sxhkd xclip dunst mpv maim syncthing libreoffice neofetch firefox sddm qt5-graphicaleffects qt5-quickcontrols2 zsh neovim polybar jsoncpp feh zathura-pdf-mupdf hplip cups simple-scan ntfs-3g udisks2 
