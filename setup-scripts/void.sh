...
sudo xbps-install arandr bluez qt6-qt5compat rustup pnpm kitty nemo elogind rofi picom yt-dlp syncthing ImageMagick void-repo-nonfree xarchiver thunar-archive-plugin xfce4-xkb-plugin
